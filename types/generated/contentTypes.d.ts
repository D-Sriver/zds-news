...
export interface ApiCardtestCardtest extends Schema.SingleType {
  collectionName: 'cardtests';
  info: {
    singularName: 'cardtest';
    pluralName: 'cardtests';
  ...
  attributes: {
    testecard: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::cardtest.cardtest',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cardtest.cardtest': ApiCardtestCardtest;
    }
  }
}
